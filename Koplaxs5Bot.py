...
cl.login(token="EqIqLtoXBNgyAdAinM50.fGIUiExEjuE1/OChSHYIia.IV0LEKv2/agUv2pInaCgFNrXoyemvVMATwK1GGbFvnE=")
cl.loginResult()

ki = LINETCR.LINE() #BotTrox2
ki.login(token="EqdTglOAbhDnNb1ufJ25.hSHvpJH1bE2GB8InsSg0vq.DjC9OI8RF0PW5Yr9nZ43WWfcdbf0KCoAjawXhrF1WpA=")
ki.loginResult()

kk = LINETCR.LINE() #BotTrox3
kk.login(token="Eq9LDXf85G96YRpttLFd.nI0+pkrzsIaJT928xZbUBq.KWdhBoqKm2/b1RfUorIgGFcGW6GUHoDkQMf6C7AkcVg=")
kk.loginResult()

kc = LINETCR.LINE() #BotTrox4
kc.login(token="EqGOdS9079hoPwKTkFWa.VSkC4kWnVqaJsixjMKNE/G.HVI5rz44AB7lGjXfoEzuWoy7PEDwCiodJdtFWCStJ7U=")
kc.loginResult()

ks = LINETCR.LINE() #BotTrox5
ks.login(token="Equa3I6sA2hF6X49yY98.aWOMtct5v8ZYoiURB63+6a.Xu78OoGWVpsdKxImsNkFqB3UZP7g8d8uAtEQ2g36psU=")
ks.loginResult()
...
helpMessage ="""👽BotTrox PROTECT👽
Owner : Satria ✰ BotTrox☆
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Admin
[•]Ownerlist
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,"u1608ae21e5de2547b5fa8707b21ca220"]
admin=["u5d4fcfac4328049c5c423847cf1f1341","u1608ae21e5de2547b5fa8707b21ca220"] 
owner=["u1608ae21e5de2547b5fa8707b21ca220"]
whitelist=["u5d4fcfac4328049c5c423847cf1f1341"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            elif "BotTroc1 invite " in msg.text:
              if msg.from_ in admin:
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Tutup qr Trox","Close qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = random.choice(KAC).getGroup(msg.to)
                    X.preventJoinByTicket = True
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["BitTrox2 close qr","BotTrox2 tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","BotTrox","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
            ...
            elif msg.text in ["BotTrox 1 join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["BotTrox 2 join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["BotTrox 3 Join"]:
              if msg.from_ in admin:
                  X = cl.getGroup(msg.to)
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
    ...
    #-------------Fungsi Leave Group Start---------------#
            ...
            elif msg.text in ["Bye BotTrox 2"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye BotTrox 3"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye BotTrox 4"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = kc.getGroup(msg.to)
                    gs = ks.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Eh Njiiirr Ini Room apaan?")
                    random.choice(KAC).sendText(msg.to,"Ratain aja lah\nRoom Ga Berguna..")
                    random.choice(KAC).sendText(msg.to,"Jangan Baper yah Boss;")
                    msg.contentType = 13
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    random.choice(KAC).sendText(msg.to,"Succes Trox")
                                except:
  ...
  #-----------------End-----------
            elif msg.text in ["Katakan hi Trox"]:
                ki.sendText(msg.to,"Hi BotTrox 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Hi BotTrox 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Hi BotTrox 􀜁􀅔Har Har􏿿")

#-----------------------------------------------
            elif msg.text in ["Satria pekok"]:
                ki.sendText(msg.to,"Satria pekok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Satria pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Satria pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Rhara pekok"]:
                ki.sendText(msg.to,"Rhara pekok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Rhara pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Rhara pekok 􀜁􀅔Har Har􏿿")
            ...
            elif msg.text in ["Kamu pekok"]:
                ki.sendText(msg.to,"Kamu yang pekok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Kamu yang pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Kamu yang pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["#welcome"]:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to," SEMUA BOT SUDAH SIAP\nPROTECT BOS")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["Tancab","Sp"]:
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Siap Dilaksanakan Trox...")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"JANGAN KAGET EA KA")
              cl.sendText(msg.to,"Itu Creator Kami Yang imuts 😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","woy","Woi","woi","bot","Bot"]:
                 quote = ['Istri yang baik itu Istri yang Mengizinkan Suaminya untuk Poligami 😂😂😂.','Kunci Untuk Bikin Suami Bahagia itu cuma satu..\nIzinkan Suamimu Untuk Selingkuh Coyyy ','Ah Kupret Lu','Muka lu Soek😀','Ada Orang kah disini?','panggil lagi gua jitak lu','Ada Makanan Nganggur ga Coy?']
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['u3bc96c4457042e18c71c61b23f2dde72'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐BotTrox⭐⭐👈™")
